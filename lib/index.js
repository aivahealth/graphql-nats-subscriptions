...
var NatsPubSub = /** @class */ (function () {
    ...
    NatsPubSub.prototype.close = function () {
        if (this.nats) {
            this.nats.close();
        }
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var maybeClient = stan.connect(_this.options.clusterId, _this.options.clientId, {
                            url: _this.options.natsUrl,
        ...
        return new Promise(function (resolve, reject) {
            ...
            sub.on("ready", function () {
                sub.on("message", function (msg) {
                    ...
                    var timestamp = msg.getTimestamp().valueOf();
                    var result = { timestamp: timestamp, data: JSON.parse(data) };
                    onMessage(result);
                    msg.ack();
                });
